...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "Hub Data — ganhe R$ 30 a cada hora de vídeo enviada" },
      { name: "twitter:image", content: "https://hubdata.org/media/og-hubdata.jpg" },
      { name: "twitter:image:alt", content: "Hub Data — ganhe R$ 30 a cada hora de vídeo enviada" },
    ],
    links: [
