...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Hub — Filmou, Ganhou: grave tarefas e ganhe R$ 30/h" },
      { property: "og:description", content: "Grave tarefas do mundo real pelo seu celular e receba até R$ 30/h por gravações aprovadas. Cadastro grátis e saque por PIX." },
      { name: "twitter:description", content: "Grave tarefas do mundo real pelo seu celular e receba até R$ 30/h por gravações aprovadas. Cadastro grátis e saque por PIX." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "/",
          description:
            "Empresa de IA que paga colaboradores por gravações de tarefas reais do dia a dia.",
          address: [
